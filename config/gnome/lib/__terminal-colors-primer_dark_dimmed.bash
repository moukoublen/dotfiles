...
export C_09=${primer_dark_dimmed['red-4']}    # Light Red
export C_02=${primer_dark_dimmed['green-5']}  # Green
export C_10=${primer_dark_dimmed['green-4']}  # Light Green
export C_03=${primer_dark_dimmed['yellow-5']} # Yellow
export C_11=${primer_dark_dimmed['yellow-4']} # Light Yellow
export C_04=${primer_dark_dimmed['blue-5']}   # Blue
export C_12=${primer_dark_dimmed['blue-4']}   # Light Blue
export C_05=${primer_dark_dimmed['purple-5']} # Purple
export C_13=${primer_dark_dimmed['purple-4']} # Light Purple
export C_06=${primer_dark_dimmed['pink-5']}   # Turquoise
export C_14=${primer_dark_dimmed['pink-4']}   # Light Turquoise
