...
gsettings-set "com.gexperts.Tilix.Keybindings session-add-down" "<Super><Shift>d"
gsettings-set "com.gexperts.Tilix.Keybindings session-add-right" "<Super><Shift>r"
...
gsettings-set "${default_profile_path} font" 'Hack 12'
