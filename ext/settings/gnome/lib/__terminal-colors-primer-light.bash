...
export C_01=${primer_light['red-6']}    # Red
export C_09=${primer_light['red-4']}    # Light Red
export C_02=${primer_light['green-6']}  # Green
...
export C_04=${primer_light['blue-6']}   # Blue
...
export C_06=${primer_light['pink-6']}   # Turquoise
export C_14=${primer_light['pink-5']}   # Light Turquoise
