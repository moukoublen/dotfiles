...
gsettings-set "${default_profile_path} scrollbar-policy" "always"
gsettings-set "${default_profile_path} scrollback-unlimited" "true"
gsettings-set "${default_profile_path} rewrap-on-resize" "true"
...
gsettings-set "${default_profile_path} cursor-colors-set" "true"
gsettings-set "${default_profile_path} cursor-background-color" "$C_HBG"
gsettings-set "${default_profile_path} cursor-foreground-color" "$C_HFG"
